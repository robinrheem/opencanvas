...
def test_crop_to_anchor_pixel_coords_autodetected(make_image):
    ...
    Without auto-detect, multiply-by-frame-size blows past the frame, both
    ends clamp to frame width, and the crop returns the full image — silently
    breaking subject anchoring and prev-frame masking.
    """
